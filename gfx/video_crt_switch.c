...
static void crt_rpi_switch(int width,int nativr_core_width, int height, float hz);
#endif
...
{
   video_display_server_set_resolution(ra_core_width, native_core_width, height,
